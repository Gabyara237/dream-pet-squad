# Web Development Project 7 - _Dream Pet Squad_

Submitted by: **Gabriela Araujo**

This web app: **Dream Pet Squad is a playful and interactive web app where users can design their dream dog by selecting a category (like service dog or home companion), choosing a breed, and customizing abilities such as obedience, strength, and friendliness. Each pet is stored in a Supabase database and can be viewed, edited, or deleted.**
